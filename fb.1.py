...
let FILTER_REPORT_SEQUENCE = 0;
let ACTIVE_REPORT_ID = null;

function createReportContainer(reportData) {
            ...
            MAP:
                {
                    units: [],
                    center:
                        reportData.mapCenter || null,

                    zoom:
                        reportData.mapZoom || null
                },
...
/* =========================================================
   B2-23 — ENGINE → DYNAMIC REPORT BRIDGE
   SOURCE OF TRUTH:
...
window.addEventListener(
    ...
    function(event) {
        ...
        if (
            ...
            console.error(
                "❌ BETA_FARM_REPORT_DATA بدون Report معتبر"
            );
        ...
        if (!report) {
            ...
            console.error(
                "❌ ساخت Report Container شکست خورد"
            );
        ...
        /* -------------------------------------------------
           نگهداری اطلاعات خام Engine
           ------------------------------------------------- */

        report.ENGINE =
            incomingReport.engine ||
            {};


        /* -------------------------------------------------
           نگهداری Dynamic Data
           ------------------------------------------------- */

        report.DATA =
            incomingReport.dynamic ||
            {};
        ...
        if (
            incomingReport.rowId !==
                undefined &&
            incomingReport.rowId !==
                null
        ) {

            report.QUARANTINE.rowId =
                incomingReport.rowId;
        }


        report.generatedAt =
            incomingReport.generatedAt ||
        ...
        /* -------------------------------------------------
           تبدیل چهار خروجی Engine
           به Pages مستقل داخل همان Container
           ------------------------------------------------- */
            ...
            [
                {
                    ...
                    title: "نمای کاربر",
                    data:
                        incomingReport.page1
                },

                {
                    id: "PAGE-2",
                    type: "image",
                    title: "شعاع ۵ کیلومتر",
                    data:
                        incomingReport.page2
                },

                {
                    id: "PAGE-3",
                    type: "image",
                    title: "شعاع ۱۰ کیلومتر",
                    data:
                        incomingReport.page3
                },
        ...
        console.log(
            "✅ BETA_FARM_REPORT_DATA دریافت شد"
        );
...
function renderReportFromCache(reportId) {
    ...
    /*
     * Container فعلی فقط یک بار
     * از Report خوانده می‌شود.
     *
     * DOM فقط View است.
     */
    ...
    resultCount.textContent =
        ...
        /* =====================================================
       B2-23 — FILTER REPORT VIEW
       گزارش فیلتر از DATA خوانده می‌شود
       ===================================================== */
    ...
    const reportHeaders =
        report.DATA &&
        Array.isArray(report.DATA.headers)
            ? report.DATA.headers
            : [];
    ...
    pages.forEach(
        function(page, index) {
            ...
            pageBox.className =
                "beta-farm-report-page";

            pageBox.dataset.pageId =
                page.id ||
                ("PAGE-" + (index + 1));
            ...
            /*
             * فعلاً فقط Pageهای تصویری.
             * داده اصلی همچنان داخل
             * REPORT_CACHE باقی می‌ماند.
             */
       ...
       footer.textContent =
        ...
        if (
            ...
            html =
                ...
                /* =====================================================
           B2-23 — APPLY FILTER → REPORT DATA
           ===================================================== */
        FILTER_REPORT_SEQUENCE++;
        const reportId =
            createReportContainer({
...
function TabGuardianReportFrame() {
 alert("TabGuardianReportFrame اجرا شد");
...
if (reportTitle) {
    ...
    reportTitle.style.margin =
        "0 0 0 8px";

    reportTitle.style.color =
        "#ffffff";

    reportTitle.style.fontWeight =
        "bold";

    reportTitle.style.fontSize =
        "13px";

    reportTitle.style.background =
        "transparent";
}
        /* =====================================================
       B2-23 — REPORT TABS CONTAINER
       یک ظرف مشترک برای همه Reportها
       ===================================================== */
    ...
    if (reportTabs) {
        ...
        reportTabs.style.display =
            "flex";

        reportTabs.style.flex =
            "1";

        reportTabs.style.height =
            "100%";

        reportTabs.style.alignItems =
            "center";

        reportTabs.style.gap =
            "4px";

        reportTabs.style.overflowX =
            "auto";

        reportTabs.style.overflowY =
            "hidden";

        reportTabs.style.boxSizing =
            "border-box";
    ...
    resultTableBox.insertBefore(
        header,
        resultTableBox.firstChild
    );
    ...
    minimizeBtn.addEventListener(
        ...
        function(event) {
            ...
            maxShareBtn.style.cursor =
                "pointer";
            maxExitBtn.style.background = "#d9e7f3";
            maxToolsBtn.style.background = "#d9e7f3";
            maxPrintBtn.style.background = "#d9e7f3";
            maxShareBtn.style.background = "#d9e7f3";    
            restoreBtn.style.background = "#d9e7f3";
                        /* =================================================
               ناحیهٔ محتوای گزارش
               ================================================= */
